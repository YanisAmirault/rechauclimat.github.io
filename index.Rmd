...
tm_shape(idf) +
  ...
  tm_fill(col = "white", alpha = 0.01, popup.vars = "com_name_upper", group = "Autres communes") +

tm_shape(paris) +
  tm_fill(col = "red", alpha = 0.8, group = "Paris", popup.vars = "com_name_upper") +
  tm_borders(col = "darkred", lwd = 2) +

tm_shape(selection) +
  tm_fill(col = "skyblue", group = "Communes étudiées", popup.vars = "com_name_upper") +
  tm_borders(col = "blue", lwd = 2) +

tm_layout(legend.outside = TRUE,
          legend.title.size = 1.1,
          main.title = "Localisation des communes étudiées",
          main.title.size = 1.2)
```
